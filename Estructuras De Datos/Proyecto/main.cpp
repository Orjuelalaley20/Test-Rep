...
// }
 ...
 int main(){
     ...
     cout <<" listar_municipios c�digo_depto"<< endl;
     cout <<" listar_poblaciones c�digo_municipio"<<endl;
     cout <<" info_sumaria c�digo_depto"<<endl;
     cout <<" carga_SC  nombre_archivo"<<endl;
     cout <<" esta_en_sistema c�digo_municipio"<<endl;
     cout <<" salida"<<endl;
    //while (valido==true){
        cout <<"$ ";
        cin>>comando;
